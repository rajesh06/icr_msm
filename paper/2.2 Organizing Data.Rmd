...
```
The `markov_data` dataframe is now ready to be used to create our Markov transition matrices. We provide the first few rows of this data to allow the reader to understand the final organization.
...
Finally, we use the `mtms` function contained in the `R` package accompanying this paper to create an `R` list object containing the incremenatal Markov transition matrices to be used in our simulation. 
