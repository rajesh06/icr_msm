...
mtm_selections[[1]] <- update_mtm_selection(mtm_selections[[1]], 
  from = 'oz', to = 'cz', selection = .3)
mtm_selections[[1]] <- update_mtm_selection(mtm_selections[[1]], 
  from = 'oz', to = 'cnz', selection = .1)
mtm_selections[[1]] <- update_mtm_selection(mtm_selections[[1]], 
  from = 'oz', to = 'oz', selection = .5)
mtm_selections[[1]] <- update_mtm_selection(mtm_selections[[1]], 
  from = 'oz', to = 'onz', selection = .1)

```                                           
                                            
We use the `update_mtm_selections` function from the package that accompanies this paper.
