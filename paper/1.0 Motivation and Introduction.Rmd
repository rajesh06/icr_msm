...
Consistent with that goal our intent is to provide a fully reproducible "worked example" with this paper. That is, we strive to present a _practical approach_ rather a theoretical approach. We also present and open-source the related code to encourage further development of this model.
