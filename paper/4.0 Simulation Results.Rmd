...
Section 4.0 discusses using the Markov Transition Matrices created to generate a simulation on all open claims in the modeled data. The end result of this simulation gives us the when and how (with our without value) each open claim is simulated to close.
...
results <- mapply(cbind, results, "paid" = open_claims$cum_paid)
