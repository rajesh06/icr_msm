We can now turn our attention to the development model. We create our analysis data by filtering out claims that do not develop. (We dealt with claims that don't develop in the prior section.) We also only concern ourselves with development on non-zero claims. 
...
For brevity, we will only present the model for claiming lag 2.
